...
#define VS10XX_RST(x)       do{ x ? \
                                  HAL_GPIO_WritePin(VS10XX_RST_GPIO_PORT, VS10XX_RST_GPIO_PIN, GPIO_PIN_SET) : \
                                  HAL_GPIO_WritePin(VS10XX_RST_GPIO_PORT, VS10XX_RST_GPIO_PIN, GPIO_PIN_RESET); \
                            }while(0)

#define VS10XX_XCS(x)       do{ x ? \
                                  HAL_GPIO_WritePin(VS10XX_XCS_GPIO_PORT, VS10XX_XCS_GPIO_PIN, GPIO_PIN_SET) : \
                                  HAL_GPIO_WritePin(VS10XX_XCS_GPIO_PORT, VS10XX_XCS_GPIO_PIN, GPIO_PIN_RESET); \
                            }while(0)

#define VS10XX_XDCS(x)      do{ x ? \
                                  HAL_GPIO_WritePin(VS10XX_XDCS_GPIO_PORT, VS10XX_XDCS_GPIO_PIN, GPIO_PIN_SET) : \
                                  HAL_GPIO_WritePin(VS10XX_XDCS_GPIO_PORT, VS10XX_XDCS_GPIO_PIN, GPIO_PIN_RESET); \
                            }while(0)

#define VS10XX_DQ           HAL_GPIO_ReadPin(VS10XX_DQ_GPIO_PORT, VS10XX_DQ_GPIO_PIN)
